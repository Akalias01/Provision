...
object GlassColors {
    ...
    // Reverie - Whisky accent for TEXT and ICONS
    // Lighter than original, closer to Audible orange but richer/warmer
    val ReverieAccent = Color(0xFFE5941F)         // Warm golden whisky - brighter, inviting
    val ReverieAccentPressed = Color(0xFFE5941F).copy(alpha = 0.80f)
    val ReverieAccentGlow = Color(0xFFE5941F).copy(alpha = 0.25f)
    val ReverieAccentSubtle = Color(0xFFE5941F).copy(alpha = 0.15f)

    // Selection highlights - Medium dark slate (neutral, no warmth)
    val SelectionGlass = Color(0xFF2D3339)       // Medium dark slate for selected backgrounds
    val SelectionBorder = Color(0xFF3D444D).copy(alpha = 0.60f)  // Slate border
    val SelectionGlow = Color(0xFF3D444D).copy(alpha = 0.20f)    // Slate glow

    // Background colors for selections (dark slate)
    val WarmSlate = Color(0xFF3D444D)           // Slate for structure
    val SubtleSlate = Color(0xFF2D3339).copy(alpha = 0.50f)  // Subtle slate for backgrounds

    // Button backgrounds - Medium dark slate (text is copper, background is slate)
    val ButtonBackground = Color(0xFF2D3339)     // Medium dark slate button bg (dark mode)
    val ButtonBackgroundLight = Color(0xFF3D444D).copy(alpha = 0.25f) // Slate button bg (light mode)
    ...
    val SubtleCopper = SubtleSlate  // Alias for backwards compatibility
    ...
    val ReadingGlassPrimary = Color(0xFF6B7F5E).copy(alpha = 0.08f)   // Moss green glass
    val ReadingGlassSecondary = Color(0xFF6B7F5E).copy(alpha = 0.05f)
    val ReadingGlassBorder = Color(0xFF6B7F5E).copy(alpha = 0.15f)
    val ReadingGlassCard = Color(0xFF6B7F5E).copy(alpha = 0.06f)
    ...
    // Reading Mode Accent - Moss Green
    val ReadingAccent = Color(0xFF6B7F5E)               // Moss Green
    val ReadingAccentPressed = Color(0xFF6B7F5E).copy(alpha = 0.80f)
    val ReadingAccentGlow = Color(0xFF6B7F5E).copy(alpha = 0.25f)

    // Reading Mode Divider
    val ReadingDivider = Color(0xFF6B7F5E).copy(alpha = 0.08f)
